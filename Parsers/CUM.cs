...
namespace errchk.Parsers {
    ...
    public class CUM : Plugin {

        public override string Key => "CUM";
        public override string Name => "CUM Parser";
        ...
        private (int Errors, int Warnings) TraceCustomer(string path, string customerId) {
            var _errors = 0;
            var _warnings = 0;

            Helpers.Report.PrintTrace(path, "CUM", customerId);
